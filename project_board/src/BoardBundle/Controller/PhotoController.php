...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $photos = $em->getRepository('BoardBundle:Photo')->findAll();
    ...
    {
        $photo = new Photo();
        $form = $this->createForm('BoardBundle\Form\PhotoType', $photo);
    ...
    {
        $deleteForm = $this->createDeleteForm($photo);
        $editForm = $this->createForm('BoardBundle\Form\PhotoType', $photo);
